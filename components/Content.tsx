    ...
    <section className="w-full min-h-screen mx-auto flex flex-col justify-center items-center bg-white transition-colors duration-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center justify-center w-full mt-10">
          ...
          <div {...aosProps} className="mt-8 text-xl text-black text-center w-full">
          ...
          <div {...aosProps} className="mt-8 text-xl text-black text-center w-full">
            ...
            <div className="text-large font-bold text-gray-700 mt-2">
              <MapInfo />
            </div>
          </div>
          <div {...aosProps} className="mt-8 text-xl text-black text-center w-full">
            <div className="font-bold text-lg">CONTACT</div>
            <p className="text-large text-gray-700 mt-2">
              Harry & Franko
            </p>
          </div>
        </div>
